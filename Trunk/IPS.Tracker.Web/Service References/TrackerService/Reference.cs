...
namespace IPS.Tracker.Web.TrackerService {
    ...
    public interface ITrackerService {
        ...
        IPS.Tracker.Web.TrackerService.DefectDTO ReportNewDefect(string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int reporterId, short priority, byte[] defectFile);
    ...
    public partial class TrackerServiceClient : System.ServiceModel.ClientBase<IPS.Tracker.Web.TrackerService.ITrackerService>, IPS.Tracker.Web.TrackerService.ITrackerService {
        ...
        public IPS.Tracker.Web.TrackerService.DefectDTO ReportNewDefect(string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int reporterId, short priority, byte[] defectFile) {
