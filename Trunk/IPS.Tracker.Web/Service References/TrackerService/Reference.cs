...
namespace IPS.Tracker.Web.TrackerService {
    ...
    public interface ITrackerService {
        ...
        IPS.Tracker.Web.TrackerService.DefectDTO ReportNewDefect(string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int reporterId, short priority, byte[] defectFile, string defectFileType);
        ...
        IPS.Tracker.Web.TrackerService.DefectDTO SaveDefect(int id, string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int changedById, short priority, string state);
        ...
        System.Collections.Generic.List<IPS.Tracker.Web.TrackerService.DefectDTO> GetDefectsByWorker(int workerId);
    ...
    public partial class TrackerServiceClient : System.ServiceModel.ClientBase<IPS.Tracker.Web.TrackerService.ITrackerService>, IPS.Tracker.Web.TrackerService.ITrackerService {
        ...
        public IPS.Tracker.Web.TrackerService.DefectDTO ReportNewDefect(string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int reporterId, short priority, byte[] defectFile, string defectFileType) {
            return base.Channel.ReportNewDefect(summary, description, workOrderId, assigneeId, reporterId, priority, defectFile, defectFileType);
        }
        
        public IPS.Tracker.Web.TrackerService.DefectDTO SaveDefect(int id, string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int changedById, short priority, string state) {
        ...
        public System.Collections.Generic.List<IPS.Tracker.Web.TrackerService.DefectDTO> GetDefectsByWorker(int workerId) {
