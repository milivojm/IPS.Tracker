...
namespace IPS.Tracker.SyncService.TrackerService {
    ...
    public partial class DefectDTO : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Collections.Generic.List<IPS.Tracker.SyncService.TrackerService.DefectCommentDTO> DefectComments {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Collections.Generic.List<IPS.Tracker.SyncService.TrackerService.DefectFollowerDTO> DefectFollowers {
            get {
    ...
    public interface ITrackerService {
        ...
        IPS.Tracker.SyncService.TrackerService.DefectDTO ReportNewDefect(string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int reporterId, short priority, byte[] defectFile);
        ...
        IPS.Tracker.SyncService.TrackerService.DefectDTO SaveDefect(int id, string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int changedById, short priority, string state);
        ...
        System.Collections.Generic.List<IPS.Tracker.SyncService.TrackerService.DefectDTO> GetDefectsByWorker(int workerId);
        ...
        System.Collections.Generic.List<IPS.Tracker.SyncService.TrackerService.DefectDTO> GetDefectsByWorkOrder(int workOrderId);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITrackerServiceChannel : IPS.Tracker.SyncService.TrackerService.ITrackerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TrackerServiceClient : System.ServiceModel.ClientBase<IPS.Tracker.SyncService.TrackerService.ITrackerService>, IPS.Tracker.SyncService.TrackerService.ITrackerService {
        ...
        public IPS.Tracker.SyncService.TrackerService.DefectDTO ReportNewDefect(string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int reporterId, short priority, byte[] defectFile) {
            return base.Channel.ReportNewDefect(summary, description, workOrderId, assigneeId, reporterId, priority, defectFile);
        }
        
        public IPS.Tracker.SyncService.TrackerService.DefectDTO SaveDefect(int id, string summary, string description, System.Nullable<int> workOrderId, int assigneeId, int changedById, short priority, string state) {
            return base.Channel.SaveDefect(id, summary, description, workOrderId, assigneeId, changedById, priority, state);
        }
        ...
        public System.Collections.Generic.List<IPS.Tracker.SyncService.TrackerService.DefectDTO> GetDefectsByWorker(int workerId) {
            return base.Channel.GetDefectsByWorker(workerId);
        }
        ...
        public System.Collections.Generic.List<IPS.Tracker.SyncService.TrackerService.DefectDTO> GetDefectsByWorkOrder(int workOrderId) {
